...
Use the newest tag from [Releases](https://github.com/mnaimfaizy/agent-kit/releases), for example `v1.0.0-alpha.4`. Every file you copy and every `uses:` pin must be the **same exact tag** — see [Adopt](adopt.md).
