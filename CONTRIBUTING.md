...
bash scripts/cut-release.sh --tag v1.0.0-alpha.5                 # dry run
bash scripts/cut-release.sh --tag v1.0.0-alpha.5 --apply --publish --notes-file release-notes/v1.0.0-alpha.5.md
```
